        ...
        <div class="contact-grid-agile-w3s">
            ...
            <div class="col-md-4 contact-grid-agile-w3">
                <div class="contact-grid-agile-w32">
                    ...
                    <h4>Call Us</h4>
                    <p>01534-694323<span>01935-723484</span></p>
                </div>
            </div>
            <div class="col-md-4 contact-grid-agile-w3">
                <div class="contact-grid-agile-w33">
                    ...
                    <h4>Email</h4>
                    <p><a href="mailto:info@example.com">mobileshop@gmail.com</a><span><a href="mailto:info@example.com">obuidul.pias@gmail.com</a></span></p>
                </div>
            </div>
            ...
            <div class="agile-contact-left">
                <div class="col-md-6 address-grid">
                    ...
                    <div class="mail-agileits-w3layouts">
                        <i class="fa fa-envelope-o" aria-hidden="true"></i>
                        <div class="contact-right">
                            <p>Mail </p><a href="mailto:info@example.com">mobileshop@gmail.com</a>
                        </div>
                        <div class="clearfix"> </div>
                    </div>
                    <div class="mail-agileits-w3layouts">
