    ...
    <div id="visual">
        <div class="slide-visual">
            ...
            <ul class="slide-group">
                <li><img class="img-responsive" src="{{ asset('public/frontEnd/images/') }}" alt="Dummy Image" /></li>
                <li><img class="img-responsive" src="{{ asset('public/frontEnd/images/') }}" alt="Dummy Image" /></li>
                <li><img class="img-responsive" src="{{ asset('public/frontEnd/images/') }}" alt="Dummy Image" /></li>
            </ul>
            ...
            <div class="script-wrap">
                <ul class="script-group">
                    <li><div class="inner-script"><img class="img-responsive" src="{{ asset('public/frontEnd/images/') }}" alt="Dummy Image" /></div></li>
                    <li><div class="inner-script"><img class="img-responsive" src="{{ asset('public/frontEnd/images/') }}" alt="Dummy Image" /></div></li>
                    <li><div class="inner-script"><img class="img-responsive" src="{{ asset('public/frontEnd/images/') }}" alt="Dummy Image" /></div></li>
                </ul>
                <div class="slide-controller">
                    <a href="#" class="btn-prev"><img src="{{ asset('public/frontEnd/images/') }}" alt="Prev Slide" /></a>
                    <a href="#" class="btn-play"><img src="{{ asset('public/frontEnd/images/') }}" alt="Start Slide" /></a>
                    <a href="#" class="btn-pause"><img src="{{ asset('public/frontEnd/images/') }}" alt="Pause Slide" /></a>
                    <a href="#" class="btn-next"><img src="{{ asset('public/frontEnd/images/') }}" alt="Next Slide" /></a>
                </div>
            </div>
